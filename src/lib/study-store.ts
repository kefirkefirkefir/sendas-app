...
export interface StudyState {
  ...
  addIdiomaTema: (idiomaId: string, texto: string) => void;
...
const DEFAULT_IDIOMAS: Idioma[] = [
  {
    ...
    temas: [
      { id: "id-t-1", texto: "Past tenses", completado: false },
      { id: "id-t-2", texto: "Future forms", completado: false },
      { id: "id-t-3", texto: "Conditionals", completado: false },
    ],
  },
];
    ...
    asignaturas: [
      {
        ...
        fechaExamen: "",
        temas: [
          { id: "at-1", texto: "Tema 1. Quattrocento", tipo: "Memorizar", completado: true, fase: "dominado" },
          { id: "at-2", texto: "Tema 2. Pintura flamenca", tipo: "Memorizar", completado: false, fase: "aprendiendo" },
        ],
      },
      {
        id: "asig-default-2",
        ...
        fechaExamen: "",
        temas: [
          { id: "at-3", texto: "Tema 1. Revolución Francesa", tipo: "Memorizar", completado: false, fase: "no_visto", prioridad: "media" },
          { id: "at-4", texto: "Tema 2. Restauración", tipo: "Memorizar", completado: false, fase: "no_visto", prioridad: "media" },
          { id: "at-5", texto: "Trabajo: La Ilustración", tipo: "Trabajo", completado: false },
        ],
      },
    ],
  },
...
export const useStudyStore = create<StudyState>()(
  persist(
    (set, get) => ({
      ...
      addIdiomaTema: (idiomaId, texto) => set((s) => ({
        idiomas: s.idiomas.map((i) =>
          i.id === idiomaId ? { ...i, temas: [...i.temas, { id: genId(), texto, completado: false }] } : i
        ),
      })),
    ...
    }),
    {
      ...
      migrate: (persisted: unknown, version: number) => {
        if (version <= 3 && persisted) {
          ...
          return { ...state, oposiciones: migratedOps, cursos: migratedCursos };
        }
