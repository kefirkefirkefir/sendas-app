...
import { useGameStore, getClassData, type Stats } from "@/lib/game-store";
    ...
    <div className="w-full">
      ...
      <div className="flex items-center gap-2 mb-0.5">
        <button
          ...
          style={{
            borderColor: view === "7days" ? "rgba(74,222,128,0.3)" : "rgba(255,255,255,0.08)",
            color: view === "7days" ? "#4ade80" : "#6b8a6b",
            backgroundColor: view === "7days" ? "rgba(74,222,128,0.06)" : "transparent",
          }}
        >
          {view === "7days" ? (
            <>
      ...
      >
        <ResponsiveContainer width="100%" height={180}>
          <RadarChart data={animatedData} cx="50%" cy="50%" outerRadius="70%">
            ...
            <PolarAngleAxis
              dataKey="label"
              tick={{ fill: "#6b8a6b", fontSize: 11, fontFamily: "monospace" }}
            />
            <PolarRadiusAxis
              angle={90}
              domain={[0, 100]}
