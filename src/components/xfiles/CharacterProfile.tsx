...
import { useGameStore, getClassData, AGENT_CLASSES, type AgentClassId, type Stats } from "@/lib/game-store";
...
function ClassDropdown({
  ...
  const current = getClassData(selected);
...
export default function CharacterProfile() {
  ...
  const currentClass = getClassData(selectedClass);
