...
export default function HomePage() {
  ...
  if (!mounted) {
    return (
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ backgroundColor: mc.bodyBg }}>
        {/* CRT scanlines */}
        <div
        ...
        <div className="text-center">
          <motion.div
            ...
            style={{
              color: mc.fgMuted,
              textShadow: `0 0 6px ${mc.glow}, 0 0 15px ${mc.tintWeak}`,
            }}
          >
          ...
          >
            <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3">
              <div className="flex items-center justify-between">
                <div className="font-mono text-[9px] tracking-wider" style={{ color: mc.fgDim }}>
                  {t.footerLeft}
                </div>
                <div className="font-mono text-[9px] tracking-wider" style={{ color: mc.fgDim }}>
                  {t.footerRight}
